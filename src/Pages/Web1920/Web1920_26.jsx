              ...
              <TableBody>
                {rows?.map((row) => (
                  ...
                  >
                    ...
                    <TableCell align="left" style={{font: "normal normal bold 18px/24px Open Sans"}} >{row.fat}€</TableCell>
                    <TableCell align="left" style={{font: "normal normal bold 18px/24px Open Sans"}} >{row.carbs}</TableCell>
                    <TableCell align="left"style={{font: "normal normal normal 18px/22px Helvetica Neue"}}>{row.protein}</TableCell>
