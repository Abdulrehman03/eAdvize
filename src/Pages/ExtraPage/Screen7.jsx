                    ...
                    <div className={classes.innerContainer}>
                        ...
                        <form className={classes.form}>
                            <div className={classes.inputbox}>
                                ...
                                <input type="text" display="inline-block" className={classes.input1} />
                            </div>
                            <div className={classes.inputbox}>
                                <label className={classes.inputLabel}>Description</label>
                                <textarea type="text" rows="8" display="inline-block" placeholder="Lorem Ipsum" className={classes.textarea} />
                            </div>
                            <div className={classes.inputbox}>
                                <label className={classes.inputLabel}>Quelles compétences je recherche ?</label>
                                <textarea placeholder="Lorem Ipsum" type="text" rows="8" display="inline-block" className={classes.textarea} />
                            </div>
                            <div className={classes.rowscontain}>
                                <Grid container>
                                    ...
                                    <Grid lg={8} md={8}>
                                        <input type="text" className={classes.inputs} name="Paris" value={paris} placeholder="Ex : Paris" />
                                    </Grid>
                                </Grid>
                            </div>
                            <div className={classes.rowscontain}>
                                <Grid container>
                                    ...
                                    <Grid sm={12} md={8}>
                                        <div className={classes.tagContainer} style={{ border: '0' }}>
                            ...
                            <div className={classes.rowscontain}>
                                <Grid container width="100%">
                                    ...
                                    <Grid md={8} xl={8}>
                                        <input type="text" className={classes.inputs} name="Paris" value={paris} placeholder="Ex : Consultant études sectorielles " />
                                    </Grid>
                                </Grid>
                            </div>
                            <div className={classes.rowscontain}>
                                <Grid container width="100%">
                                    <Grid md={12} lg={4}>
                                        <div className={classes.leftbox} style={{ minHeight: '85px' }}>
                                            Lieu de la mission
                                        </div>
                                    </Grid>
                                    <Grid sm={12} md={8}>
                                        <div style={{ minHeight: '100px' }} className={classes.tagContainer}>
