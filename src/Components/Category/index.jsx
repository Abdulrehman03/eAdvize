  ...
  return (
    <div className={classes.root}>
      <Grid container spacing={2}>
              ...
              <Grid container rowSpacing={1}>
                ...
                >
                  ...
                  >
                    <img
                      src={
                        bg === "Gestion"
                          ? "./src/public/Gestion2.svg"
                          : "./src/public/Gestion.png"
                      }
                    />
                    <p
                      className={` ${
                        bg === "Gestion" ? classes.jobTitle2 : classes.jobTitle
                      }`}
                    >
                      Gestion de Projet
                    </p>
                ...
                >
                  ...
                  >
                    ...
                    <p
                      className={` ${
                        bg === "Coaching" ? classes.jobTitle2 : classes.jobTitle
                      }`}
                    >
                      Formation Coatching
                    </p>
        ...
        <Grid item md={4} className={`${bg ? classes.sideDiv : classes.col_2}`}>
          <div className={classes.sideText}>
            ...
            <div style={{ display: bg ? "block" : "none" }}>
              ...
              <p className={classes.sideTextTerm2}>
                <Checkbox {...label} className={classes.checkBox} /> Pilotage de
                programme ou projet et PMO …
              </p>
            </div>
          </div>
        </Grid>
